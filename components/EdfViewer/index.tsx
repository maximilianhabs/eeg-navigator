...
function EdfPanel({ example, montage, sensitivity, windowSec, hpFreq, lpFreq, notch, neonMode, entityName }: {
  ...
  const draw = useCallback(() => {
    ...
    // bleiben — buildMontageRows würde für 'bipolar'/'cz'/'avg' sonst NICHT einfach
    // leer bleiben, sondern durch eine normLabel-Mehrdeutigkeit (Suffix-Strip
    // "-F7" wird wie eine Referenz-Endung "-Ref" behandelt) fälschlich Kanäle wie
    // "Fp1-F7" MINUS "F7-T3" verrechnen — eine stille, falsche Differenz zweier
    // bereits-differentieller Kanäle. Deshalb hart erzwingen, nicht nur Default.
